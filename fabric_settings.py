FABRIC = {
    "vagrant": {
        ...
        "DB_PASS": "poopyface", # Live database password
        ...
        "PROJECT_NAME": "chores", # Unique identifier for project
        "PROJECT_PATH": "/vagrant/chores",
        ...
        "REPO_URL": "git@github.com:winnietong/yetichores.git", # Git or Mercurial remote repo URL for the project
        "REPO_BRANCH": "master",
        "LINUX_DISTRO": "wheezy",
    },
    "development": {
